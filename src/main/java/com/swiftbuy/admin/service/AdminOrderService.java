...
public class AdminOrderService {
    ...
    public Order markOrderAsShipped(Long orderId) throws ResourceNotFoundException {
        ...
        if (order.getOrderStatus() == Order.OrderStatus.DELIVERED) {
            throw new IllegalStateException("Cannot mark  delivered order as shipped");
        }
    ...
    public Order markOrderAsDelivered(Long orderId) throws ResourceNotFoundException {
        Order order = orderRepository.findById(orderId)
            .orElseThrow(() -> new ResourceNotFoundException("Order not found"));
