...
public class CustomerServiceQuestionsAnswerController {
	...
	@PostMapping("/post")
	public ResponseEntity<CustomerServiceQuestionsAnswer> createQuestionAnswer(
			@RequestBody CustomerServiceQuestionsAnswer questionAnswer) {
		try {
			CustomerServiceQuestionsAnswer savedQuestionAnswer = questionsAnswerService
					.saveQuestionsAnswer(questionAnswer);
	...
	@PutMapping("/{id}")
	public ResponseEntity<CustomerServiceQuestionsAnswer> updateQuestionAnswer(@PathVariable("id") Long id,
			@RequestBody CustomerServiceQuestionsAnswer updatedQuestionAnswer) {
		try {
			CustomerServiceQuestionsAnswer updatedAnswer = questionsAnswerService.updateQuestionsAnswer(id,
